...
class DrfUserSideEffectLogPage extends StatelessWidget {
  final DateTime selectedDate;

  DrfUserSideEffectLogPage({required this.selectedDate});
                ...
                children: [
                  ...
                  ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final DrfSideEffectResponse response = controller.sideEffectResponses[index];
                      return Column(
  ...
  Widget _buildCircularButtons(
      BuildContext context, {
        required DrfSideEffectResponse response,
      }) {
