      ...
      body: Stack(
        children: [
          ...
          Obx(() {
            ...
            if (_controller.surveyResponses.isEmpty) {
              return Center(
                child: Text(
                  '해당 날짜에 기록된 내용이 없습니다.',
                  style: TextStyle(
                ...
                Expanded(
                  child: Theme(
                    ...
                    child: ListView.builder(
                      ...
                      itemCount: _controller.surveyResponses.length,
                      itemBuilder: (context, index) {
                        final subtype = _controller.surveyResponses[index];
                        return Card(
